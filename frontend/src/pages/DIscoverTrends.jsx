...
const DiscoverTrends = () => {
  ...
  useEffect(() => {
    ...
    const listItemDom = document.querySelector(
      ".explore-carousel .explore-list"
    );
    const thumbnailDom = document.querySelector(
      ".explore-carousel .explore-thumbnail"
    );
    ...
    const showSlider = (type) => {
      ...
      const itemThumbnail = document.querySelectorAll(
        ".explore-carousel .explore-thumbnail .explore-item"
      );
    ...
    <div>
      <header>
        <nav id="nav" className="explore-nav">
          ...
          <div className="explore-logo" id="logo">
            Elite Designs
          </div>
          <button
            className="hamburger"
            onClick={() => {
              setNavOpen(!navOpen);
              console.log("Hamburger clicked. navOpen state:", !navOpen);
            }}
          ...
          <div
            className={!navOpen ? "explore-navitems" : "notnavitems"}
            id="navitems"
          >
            <ul>
              <li>
              ...
              <button onClick={() => Navigate("/login")} className="uploadbtn">
                Get Started
              </button>
            </ul>
          </div>
          ...
          <div className="explore-item">
            ...
            <div className="explore-content">
              ...
              <div className="explore-des">
                Glimpse one of our most popular AI-powered creations—a stunning
        ...
        <div className="explore-photo-gallery">
          <div className="explore-column">
            <div className="explore-photo">
              {/* <img src="../img/generated_jewelryimg (1).png" alt="GI1" /> */}
              <img src="img/ab.png" alt="" />
            </div>
            <div className="explore-photo">
              <img src="img/generated_jewelryimg (2).png" alt="GI2" />
            </div>
            <div className="explore-photo">
              <img src="img/generated_jewelryimg (5).png" alt="GI6" />
            </div>
          </div>
          <div className="explore-column">
            <div className="explore-photo">
              <img src="img/generated_jewelryimg (9).png" alt="GI3" />
            </div>
            <div className="explore-photo">
              <img src="img/generated_jewelryimg (10).png" alt="GI4" />
            </div>
            <div className="explore-photo">
              <img src="img/generated_jewelryimg.png" alt="GI5" />
            </div>
          </div>
          <div className="explore-column">
            <div className="explore-photo">
              <img src="img/generated_jewelryimg (6).png" alt="GI7" />
            </div>
            <div className="explore-photo">
              <img src="img/generated_jewelryimg (7).png" alt="GI8" />
            </div>
            <div className="explore-photo">
              <img src="img/generated_jewelryimg (8).png" alt="GI9" />
            </div>
          </div>
        </div>
      </div>
